...
void main()
{
    ...
    myptrs[13] = &mychars[0]; // point to start of valid byte array; as this pointer will be dereferenced by _still_works
	...
	_still_works(myptrs, myptrs[13], &mychars[3564], 0xDEADBEEF);
}
